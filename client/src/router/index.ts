    ...
    { path: '/', redirect: () => (localStorage.getItem('ask-plant.accessToken') ? '/admin/dashboard' : '/p') },
    {
      ...
      children: [
        { path: '', redirect: '/admin/dashboard' },
        {
          ...
          meta: { title: 'Dashboard', breadcrumb: ['Dashboard'], isMock: false, roles: ['ADMIN', 'STAFF', 'CUSTOMER'] as UserRole[] },
        },
        {
          path: 'species',
        ...
        },
        {
          ...
          meta: { title: '위치관리', breadcrumb: ['위치관리'], isMock: false, roles: ['ADMIN', 'STAFF', 'CUSTOMER'] as UserRole[] },
        },
        {
          path: 'locations/:id',
          name: 'admin-location-detail',
          component: () => import('@/views/admin/locations/LocationDetailView.vue'),
          meta: { title: '위치 상세', breadcrumb: ['위치관리', '위치 상세'], isMock: false, roles: ['ADMIN', 'STAFF', 'CUSTOMER'] as UserRole[] },
        },
        {
          path: 'photos',
          name: 'admin-photo-list',
          component: () => import('@/views/admin/photos/PhotoListView.vue'),
          meta: { title: '사진관리', breadcrumb: ['사진관리'], isMock: false, roles: ['ADMIN', 'STAFF', 'CUSTOMER'] as UserRole[] },
        },
        {
          path: 'qr',
          name: 'admin-qr-list',
          component: () => import('@/views/admin/qr/QrListView.vue'),
          meta: { title: 'QR관리', breadcrumb: ['QR관리'], isMock: false, roles: ['ADMIN', 'STAFF', 'CUSTOMER'] as UserRole[] },
        },
        {
          path: 'qr/:plantId',
          name: 'admin-qr-detail',
          component: () => import('@/views/admin/qr/QrDetailView.vue'),
          meta: { title: 'QR 상세', breadcrumb: ['QR관리', 'QR 상세'], isMock: false, roles: ['ADMIN', 'STAFF', 'CUSTOMER'] as UserRole[] },
        },
        {
          path: 'common-codes',
        ...
        },
        {
          ...
          meta: { title: '설정', breadcrumb: ['설정'], isMock: false, roles: ['ADMIN', 'STAFF', 'CUSTOMER'] as UserRole[] },
        },
      ],
    },
    {
