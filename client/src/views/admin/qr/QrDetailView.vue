    ...
    <div class="qr-detail-grid">
      ...
      <section class="panel info-card">
        ...
        <div class="info-row actions-row">
          <BaseButton variant="outline" size="sm" :to="`/admin/plants/${plantId}`">개체 상세</BaseButton>
          <BaseButton variant="outline" size="sm" :to="qrStore.preview.publicPath" target="_blank">공개 페이지</BaseButton>
        </div>
